...
| Element | Status |
|---------|--------|
| **Party** | Battered; Augustus MAX STRESS |
| **Artifact** | Secured, world-ending threat confirmed |
| **Contract** | BROKEN |
| **Faction** | Fugitives; heroes in Last Light |
| **New Threat** | Supply chain corruption |
| **Lore Mysteries** | Runes origin? Craven's cycle? Pure eagles? |
