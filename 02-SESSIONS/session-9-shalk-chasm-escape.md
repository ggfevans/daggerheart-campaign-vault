...
- Currently in **Shalk Chasm**, leaving Void Spire
- Searching for alternate exit route
- Party morale strong, equipped with gifted items

## Combat Resolution
- [[craven]] eliminated after brutal 6-round battle
- Party acquired reddish orb (world-ending cosmic horror artifact)
- Augustus survived unconsciousness, evacuated with party

## Character Status
- **Vaerenth**: Operational
- **Banjo**: Operational  
...
- Party now possesses item Chainlord commissioned
- Refusing delivery = becoming rogue agents
...
### Rune Discovery (Banjo - CRIT knowledge)
- Runes amplifying downpour + bitter cold
- **Confirmation**: Runes are hostile to party
- **Cold saves** (Round 1):
  - Vaerenth: SUCCESS
  - Banjo, Augustus, Aster: FAIL (all suffer)

### Food Hunt & Warmth
- **Aster + Banjo**: Spot "crimpers" (centipede-rats, fish eyes, long torsos)
- **Cold saves** (Round 2):
  - Vaerenth: [holding]
  - Augustus, Banjo: FAIL (worsening)
  - Aster: SUCCESS
- **Hunt action**: Vaerenth's nomadic pack provides net; Banjo shadowsteps behind nest, drops net
  - **Catch**: 5 crimpers trapped
- **Camp**: Cook crimpers over fire → warmth + food regain

### Night Camp & Rune Disruption

#### Rest & Recovery
- Party camps with fire through night
- Warmth + food stabilize condition
- Augustus & Banjo begin recovery

#### Rune Destruction - Augustus
- **Action**: Taps cane against rune in morning
- **Impact**: Strong hit damages surrounding rock
- **Effect**: Rune partially disrupted

#### Rune Destruction - Banjo
- **Action**: Uses returning blade to carve out rune completely
- **Result**: RUNE SEVERED
- **Immediate Effect**: Thunderous blast in sky
- **Weather shift**: Air temperature dramatically changes
- **TRIGGER**: Loud bang echoes—avalanche begins!

#### Avalanche Incoming
- **Scale**: Mountain pass collapsing
- **Threat**: Party must evacuate/escape fast
- **Status**: In immediate danger

#### Avalanche Escape Rolls
- **Banjo**: SUCCEEDS agility roll - evades avalanche
- **Vaerenth**: FAILS - knocked down
- **Augustus**: FAILS - knocked down (already wounded)
- **Aster**: FAILS - knocked down
- **Impact**: Party separated; three thrown 200+ feet downslope
- **Damage**: Vaerenth, Augustus, Aster each take 15 damage
- **Landing**: Knocked to narrow ledge below
- **Party status**: 
  - Banjo: Above, safe but isolated
  - Others: Below on ledge, damaged, regrouping needed

#### Damage Distribution
- **Banjo**: Calls apology from above (regret for rune destruction)
- **Augustus**: Takes minor damage, blocks with armor - **AT MAX STRESS**
